...
const styles = StyleSheet.create({
  ...
  processingEmoji: { fontSize: 56, marginBottom: 8 },
  processingTitle: { fontSize: 20, fontWeight: '800', color: '#4F46E5', marginBottom: 6 },
  processingSub: { fontSize: 15, fontWeight: '500', color: '#6366f1', marginBottom: 4 },
